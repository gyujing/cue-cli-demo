    ...
    <el-dialog :title="title" :visible.sync="dialogVisible" width="500px" @opened="getData">
        <el-form :model="userForm" :rules="rules" ref="userForm" size="small" label-width="70px">
            <el-form-item label="账号" prop="account">
                <el-input :disabled="userForm.userId ? true : false" clearable v-model="userForm.account"></el-input>
            </el-form-item>
            <el-form-item label="密码" prop="password">
              <template #label>
                <span v-if="!userForm.userId" style="color:#F56C6C;margin-right: 4px;">*</span><span>密码</span>
              </template>
                <el-input
                    :disabled="userForm.userId ? true : false"
            ...
            <el-form-item label="姓名" prop="userName">
                <el-input placeholder="请输入姓名" clearable v-model="userForm.userName"></el-input>
            </el-form-item>
            <el-form-item label="部门">
                <el-input placeholder="请输入部门" clearable v-model="userForm.department"></el-input>
            </el-form-item>
            <el-form-item label="职位">
                <el-input placeholder="请输入职位" clearable v-model="userForm.position"></el-input>
            </el-form-item>
            <el-form-item label="角色" prop="roleId">
                <el-select style="width: 100%" v-model="userForm.roleId" filterable clearable placeholder="请选择角色">
                    <el-option v-for="(item, index) in roleList" :key="Number(index)" :label="item.name" :value="item.id"> </el-option>
                </el-select>
            </el-form-item>
        </el-form>
        <span slot="footer" class="dialog-footer">
            <el-button size="small" @click="handleClose">取 消</el-button>
            <el-button size="small" type="primary" @click="enter('userForm')">确 定</el-button>
        </span>
    </el-dialog>
</template>
